...
variable "ec2instance_user_data" {}
variable "ec2instance_vpc_security_groups_ids" {}
...
module "ec2instance" {
  ...
  user_data = "${var.ec2instance_user_data}"
  vpc_security_groups_ids = "${var.ec2instance_vpc_security_groups_ids}"
}